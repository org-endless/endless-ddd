...
impl Installer {
    ...
    pub fn get_system_info(&self) -> Result<SystemInfo> {
        ...
        // 获取磁盘空间
        let available_disk_space = fs::metadata("../../endless-ddd-generator/tauri")
    ...
    pub async fn select_install_path(&self) -> Result<Option<String>> {
        ...
        let default_path = match std::env::consts::OS {
            "windows" => "C:\\Program Files\\Endless DDD Generator",
            "macos" => "/Applications/Endless DDD Generator",
            _ => "/opt/endless-ddd-generator",
        };
    ...
    async fn copy_application_files(&self, install_path: &Path) -> Result<()> {
        ...
        // 复制可执行文件
        let exe_dst = install_path.join("endless-ddd-generator.exe");
    ...
    async fn create_desktop_shortcut(&self, install_path: &Path) -> Result<()> {
        #[cfg(target_os = "windows")]
        {
            ...
            let shortcut_path = desktop.join("Endless DDD Generator.lnk");
            ...
            let script = format!(
                ...
                install_path.join("endless-ddd-generator.exe").display(),
    ...
    async fn create_start_menu_shortcut(&self, install_path: &Path) -> Result<()> {
        #[cfg(target_os = "windows")]
        {
            ...
            let shortcut_path = start_menu.join("Endless DDD Generator.lnk");
    ...
    async fn setup_auto_start(&self, install_path: &Path) -> Result<()> {
        #[cfg(target_os = "windows")]
        {
            ...
            let exe_path = install_path.join("endless-ddd-generator.exe");
    ...
    async fn remove_shortcuts(&self) -> Result<()> {
        #[cfg(target_os = "windows")]
        {
            ...
            let desktop_shortcut = desktop.join("Endless DDD Generator.lnk");
            ...
            let start_menu_shortcut = start_menu.join("Endless DDD Generator.lnk");
