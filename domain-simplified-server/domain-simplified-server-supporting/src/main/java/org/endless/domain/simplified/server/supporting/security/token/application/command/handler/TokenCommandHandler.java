 ...
 *
 * @author Deng Haozhi
 * @see DomainSimplifiedServerCommandHandler<TokenAggregate>
 * @since 2.0.0
 */
public interface TokenCommandHandler extends DomainSimplifiedServerCommandHandler<TokenAggregate> {
}
