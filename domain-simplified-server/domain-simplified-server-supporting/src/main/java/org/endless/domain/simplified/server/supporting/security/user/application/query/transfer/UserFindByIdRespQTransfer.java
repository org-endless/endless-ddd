...
public class UserFindByIdRespQTransfer implements DomainSimplifiedServerQueryTransfer {
    ...
    @Override
    public UserFindByIdRespQTransfer validate() {
        validateUserId();
        return this;
    }
