package org.endless.domain.simplified.generator.service;
            ...
            Optional.ofNullable(aggregate.getEntities())
                    ...
                    .ifPresent(entities -> entities.forEach(entity -> {
                        try {
                            ...
                            if (generatorDTO.getEnableRecord()) {
                                DataRecordGenerator recordGenerator = new DataRecordGenerator();
                                recordGenerator.generateEntity(aggregate, entity);
                                recordGenerator.generateAssociation(aggregate, entity);
                            }
                            if (generatorDTO.getEnableRepository()) {
