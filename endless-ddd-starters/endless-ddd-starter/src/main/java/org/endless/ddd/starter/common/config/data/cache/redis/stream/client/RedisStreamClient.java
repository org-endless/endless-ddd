package org.endless.ddd.starter.common.config.data.cache.redis.stream.client;

import org.endless.ddd.starter.common.exception.config.redis.RedisStreamAddException;
...
public class RedisStreamClient<T> {
    ...
    public void add(String streamKey, T message) {
        try {
            ...
            throw new RedisStreamAddException(e);
        }
    }
