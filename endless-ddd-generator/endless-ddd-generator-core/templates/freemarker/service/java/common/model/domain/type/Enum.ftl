...
package ${servicePackage}.domain.type;

import ${endlessPackage}.domain.type.BaseEnum;

/**
 * ${service.getName()}Enum
 * <p>
 ...
 */
public interface ${service.getName()}Enum extends BaseEnum {
