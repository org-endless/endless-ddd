...
package ${servicePackage}.application.command.transfer;

import ${endlessPackage}.application.command.transfer.CommandTransfer;

/**
 * ${service.getName()}CommandTransfer
 * <p>
 ...
 */
public interface ${service.getName()}CommandTransfer extends CommandTransfer {
