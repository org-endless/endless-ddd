...
import ${endlessPackage}.domain.anticorruption.DrivenAdapter;

/**
 * ${service.getName()}DrivenAdapter
 * <p>
 ...
 */
public interface ${service.getName()}DrivenAdapter extends DrivenAdapter {
