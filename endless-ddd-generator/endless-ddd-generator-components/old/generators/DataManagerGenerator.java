...
import org.endless.ddd.generator.object.entity.Entity;
...
import static org.endless.ddd.generator.template.ConstructorTemplate.allArgsConstructor;
import static org.endless.ddd.generator.template.DefineTemplate.classDefine;
import static org.endless.ddd.generator.template.EndTemplate.end;
import static org.endless.ddd.generator.template.FieldTemplate.fields;
import static org.endless.ddd.generator.template.HeaderTemplate.importHeaderDataManager;
...
import static org.endless.ddd.generator.utils.StringTools.exchangeSuffix;
import static org.endless.ddd.generator.utils.StringTools.removeSuffix;
...
public class DataManagerGenerator {
    ...
    private void save(StringBuilder stringBuilder, List<String> entityMappers, String className, String recordName, String mapperName, String aggregateName, String aggregateDescription) {
        stringBuilder
                .append("    @Override\n")
                .append("    @Log(message = \"").append(aggregateDescription).append("聚合保存数据\", value = \"#domain\", level = LogLevel.TRACE)\n")
                .append("    public ").append(aggregateName).append(" save(").append(aggregateName).append(" domain) {\n")
                .append("        Optional.ofNullable(domain)\n")
                .append("               .orElseThrow(() -> new DataManagerSaveException(\"要保存的").append(aggregateDescription).append("聚合不能为空\"));\n")
                .append("        ").append(recordName).append(" record = ").append(className).append(".from(domain);\n");
