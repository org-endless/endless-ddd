...
//     }
//
//     public void generate(org.endless.ddd.generator.object.dto.GeneratorDTO generatorDTO) {
//         log.debug("开始生成代码");
//         log.debug(generatorDTO.toString());
//         try {
//             Aggregate domain = getAggregate(
//                     org.endless.ddd.generator.object.dto.AggregateDTO.builder()
...
//     }
//
//     public Aggregate getAggregate(org.endless.ddd.generator.object.dto.AggregateDTO aggregateDTO) {
//         log.debug("开始读取聚合信息");
//         try {
//             Yaml yaml = new Yaml();
