...
/**
 * ProjectFindSimpleProfileRespQTransferReq
 * <p>项目基本信息查询响应传输对象
 * <p>
...
public record ProjectFindSimpleProfileRespQTransferReq(
        String projectId, String name) implements DDDGeneratorReqQueryTransfer {

    @Override
    public ProjectFindSimpleProfileRespQTransferReq validate() {
        validateProjectId();
        validateName();
        return this;
    }
