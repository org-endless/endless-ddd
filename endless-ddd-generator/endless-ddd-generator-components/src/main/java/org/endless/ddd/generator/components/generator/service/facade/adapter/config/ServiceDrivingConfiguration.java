package org.endless.ddd.generator.components.generator.service.facade.adapter.config;

import org.endless.ddd.generator.components.generator.service.application.command.handler.ServiceCommandHandler;
import org.endless.ddd.generator.components.generator.service.application.command.handler.impl.ServiceCommandHandlerImpl;
...
import org.endless.ddd.generator.components.generator.service.application.query.handler.impl.ServiceQueryHandlerImpl;
...
import org.endless.ddd.generator.components.generator.service.facade.adapter.spring.SpringServiceDrivingAdapter;
...
public class ServiceDrivingConfiguration {
    ...
    @Lazy
    @ConditionalOnMissingBean
    protected @Bean ServiceCommandHandler serviceCommandHandler(ServiceRepository serviceRepository, ServiceDrivenAdapter serviceDrivenAdapter) {
        return new ServiceCommandHandlerImpl(serviceRepository, serviceDrivenAdapter);
    }

    @Lazy
    @ConditionalOnMissingBean
    protected @Bean ServiceQueryHandler serviceQueryHandler(ServiceQueryRepository serviceQueryRepository) {
        return new ServiceQueryHandlerImpl(serviceQueryRepository);
    }
}
