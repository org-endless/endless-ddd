package org.endless.ddd.generator.components.generator.project.facade.adapter.config;

import org.endless.ddd.generator.components.generator.project.application.command.handler.ProjectCommandHandler;
import org.endless.ddd.generator.components.generator.project.application.command.handler.impl.ProjectCommandHandlerImpl;
...
import org.endless.ddd.generator.components.generator.project.application.query.handler.impl.ProjectQueryHandlerImpl;
...
import org.endless.ddd.generator.components.generator.project.facade.adapter.spring.SpringProjectDrivingAdapter;
...
public class ProjectDrivingConfiguration {
    ...
    @Lazy
    @ConditionalOnMissingBean
    protected @Bean ProjectQueryHandler projectQueryHandler(ProjectQueryRepository projectQueryRepository) {
        return new ProjectQueryHandlerImpl(projectQueryRepository);
    }
}
