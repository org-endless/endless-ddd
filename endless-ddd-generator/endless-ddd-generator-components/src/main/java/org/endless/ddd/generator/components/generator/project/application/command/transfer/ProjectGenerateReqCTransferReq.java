...
/**
 * ProjectGenerateReqCTransferReq
 * <p>项目生成命令请求传输对象
 * <p>
...
public record ProjectGenerateReqCTransferReq(String projectId) implements DDDGeneratorReqCommandTransfer {

    @Override
    public ProjectGenerateReqCTransferReq validate() {
        validateProjectId();
        return this;
    }
