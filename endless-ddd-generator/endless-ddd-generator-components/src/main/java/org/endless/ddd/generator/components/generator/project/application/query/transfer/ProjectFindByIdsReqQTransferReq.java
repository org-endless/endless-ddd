...
/**
 * ProjectFindByIdsReqQTransferReq
 * <p>项目根据ID列表查询请求传输对象
 * <p>
...
public record ProjectFindByIdsReqQTransferReq(List<String> projectIds) implements DDDGeneratorReqQueryTransfer {

    @Override
    public ProjectFindByIdsReqQTransferReq validate() {
        return this;
    }
}
