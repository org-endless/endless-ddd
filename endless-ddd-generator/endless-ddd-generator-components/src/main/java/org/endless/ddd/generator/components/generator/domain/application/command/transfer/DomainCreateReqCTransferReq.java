...
public record DomainCreateReqCTransferReq(
        String contextId, String name, String description, String version, String author,
        List<AggregateFieldReqCTransferReq> fields) implements DDDGeneratorReqCommandTransfer {

    @Override
    public DomainCreateReqCTransferReq validate() {
        validateContextId();
        validateName();
        validateDescription();
        validateVersion();
