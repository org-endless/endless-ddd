...
/**
 * ContextFindByServiceIdReqQTransferReq
...
public record ContextFindByServiceIdReqQTransferReq(String serviceId) implements DDDGeneratorReqQueryTransfer {

    @Override
    public ContextFindByServiceIdReqQTransferReq validate() {
        validateServiceId();
        return this;
    }
