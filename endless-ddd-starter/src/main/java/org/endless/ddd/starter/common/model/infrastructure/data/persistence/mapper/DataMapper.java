package org.endless.ddd.starter.common.model.infrastructure.data.persistence.mapper;
...
import org.endless.ddd.starter.common.exception.model.infrastructure.data.persistence.mapper.*;
import org.endless.ddd.starter.common.model.domain.entity.Entity;
import org.endless.ddd.starter.common.model.infrastructure.data.persistence.page.PageCallback;
import org.endless.ddd.starter.common.model.infrastructure.data.record.DataRecord;
import org.endless.ddd.starter.common.utils.database.DatabaseErrorParser;
...
public interface DataMapper<R extends DataRecord<? extends Entity>> extends BaseMapper<R> {
    ...
    default void upsert(R record) {
        ...
        try {
            ...
            throw new MapperUpsertUnknownException("数据库新增或修改记录异常: " + DatabaseErrorParser.parse(e.getMessage()), e);
        }
    }
    ...
    default void remove(R record) {
        ...
        try {
            ...
            throw new MapperRemoveUnknownException("数据库删除记录异常: " + DatabaseErrorParser.parse(e.getMessage()), e);
        }
    }
    ...
    default void modify(R record, R existingRecord) {
        ...
        while (retryCount < MAX_RETRY_COUNT) {
            ...
            try {
                ...
                throw new MapperModifyUnknownException("数据库修改记录异常: " + DatabaseErrorParser.parse(e.getMessage()), e);
            }
        }
    }
}
