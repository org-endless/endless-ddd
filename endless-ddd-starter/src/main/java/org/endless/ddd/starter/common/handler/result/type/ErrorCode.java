package org.endless.ddd.starter.common.handler.result.type;

import lombok.AllArgsConstructor;
import lombok.Getter;
import lombok.ToString;
import org.endless.ddd.starter.common.exception.model.domain.type.EnumException;
import org.endless.ddd.starter.common.model.domain.type.BaseEnum;
...
public enum ErrorCode implements BaseEnum {
    ...
    DDP0100("DDP0100", "MyBatis-Plus数据库操作失败"),
    DDP0101("DDP0101", "MyBatis-Plus数据库操作状态未知"),
    DDP0110("DDP0110", "MyBatis-Plus数据库新增操作失败"),
    DDP0111("DDP0111", "MyBatis-Plus数据库新增操作状态未知"),
    DDP0120("DDP0120", "MyBatis-Plus数据库删除操作失败"),
    DDP0121("DDP0121", "MyBatis-Plus数据库删除操作状态未知"),
    DDP0130("DDP0130", "MyBatis-Plus数据库修改操作失败"),
    DDP0131("DDP0131", "MyBatis-Plus数据库修改操作状态未知"),
    DDP0140("DDP0140", "MyBatis-Plus数据库新增或修改操作失败"),
    DDP0141("DDP0141", "MyBatis-Plus数据库新增或修改操作状态未知"),
    DDP0150("DDP0150", "MyBatis-Plus数据库查询失败"),
    DDP0160("DDP0160", "MyBatis-Plus数据库批量操作失败"),
